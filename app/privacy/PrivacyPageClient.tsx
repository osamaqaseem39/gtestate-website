...
const FALLBACK_BODY =
  'Our privacy policy is being finalized. Please contact us directly with any questions about how we handle your data.'
...
export default function PrivacyPageClient() {
  ...
  useEffect(() => {
    let cancelled = false
    fetchSiteContent('privacy').then((content) => {
      if (!cancelled) {
