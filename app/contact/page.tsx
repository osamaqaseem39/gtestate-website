            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h4 className="text-white font-semibold uppercase tracking-wider">Phone</h4>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h4 className="text-white font-semibold uppercase tracking-wider">Email</h4>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h4 className="text-white font-semibold uppercase tracking-wider">Office</h4>
                ...
                <div className="p-6 bg-white/5 border border-white/10">
                  <h4 className="text-white font-semibold mb-4 uppercase tracking-wider">Why Choose Us?</h4>
